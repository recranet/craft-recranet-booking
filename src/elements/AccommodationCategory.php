...
class AccommodationCategory extends Element
{
    ...
    {
        return Craft::t('_recranet-booking', 'Accommodation categories');
    }
    ...
    {
        return Craft::createObject(AccommodationCategoryCondition::class, [static::class]);
    }
    ...
    public function canView(User $user): bool
    {
        ...
        return $user->can('viewAccommodationCategories');
    }
    ...
    public function canSave(User $user): bool
    {
        ...
        // todo: implement user permissions
        return $user->can('saveAccommodationCategories');
    }
    ...
    public function canDelete(User $user): bool
    {
        ...
        // todo: implement user permissions
        return $user->can('deleteAccommodationCategories');
    }
    ...
    {
        return UrlHelper::cpUrl('accommodation-categories');
    }
    ...
    public function prepareEditScreen(Response $response, string $containerId): void
    {
        ...
        $response->crumbs([
            [
                ...
                'url' => UrlHelper::cpUrl('accommodation-categories'),
            ],
        ]);
    }
